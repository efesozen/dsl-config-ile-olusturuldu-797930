...
export default function CreateDslConfigurationPage() {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-6">Create DSL Configuration</h1>
      <p className="text-muted-foreground mb-6">Page for users to create new DSL configurations.</p>
